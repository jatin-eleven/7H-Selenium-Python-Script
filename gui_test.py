        ...
        if(li_Counter < 26):
            ...
            try:
                span = "/html/body/div[3]/div[5]/div/div[2]/section/div[3]/div/div/div/div[1]/div[1]/section/div/div/section/span/div/form/ol/li[" + str(
                    li_Counter)+"]/div/article/div/article/div/article/div/div[1]/div[1]/section/div/div[2]/span/span/div/a"
                ...
                for i in projects:
                    ...
                    if(free_project.lower() == i.text.lower()):
                        ...
                        project_dropdwn.find_element(
                            By.XPATH, "/html/body/div[3]/div[6]/base-slidein-container/div/div/div[2]/form/div[1]/div[1]/div/ul/li[" + str(counter) + "]")
