...
def saving_to_next(inmail_list,free_project):
    ...
    for i in li_ele:
        ...
        if(li_Counter < 26 ):
            ...
            try:
                span="/html/body/div[3]/div[5]/div/div[2]/section/div[3]/div/div/div/div[1]/div[1]/section/div/div/section/span/div/form/ol/li["+ str(li_Counter)+"]/div/article/div/article/div/article/div/div[1]/div[1]/section/div/div[2]/span/span[1]/div/a"    
            ...
            if str(textt) in inmail_list:
                free_counter+=1
                try:
                    dot_btn="/html/body/div[3]/div[5]/div/div[2]/section/div[3]/div/div/div/div[1]/div[1]/section/div/div/section/span/div/form/ol/li["+ str(li_Counter) +"]/div/article/div/article/div/article/div/div[2]/aside/span/div/div/div/div/div/div/div/div/div/div/div[1]/div[2]/div/div/button"         
                ...
                time.sleep(3)
                try : 
                    save_to_project_path = "/html/body/div[3]/div[5]/div/div[2]/section/div[3]/div/div/div/div[1]/div[1]/section/div/div/section/span/div/form/ol/li["+ str(li_Counter)+"]/div/article/div/article/div/article/div/div[2]/aside/span/div/div/div/div/div/div/div/div/div/div/div[1]/div[2]/div/div/div/div/ul/li[4]/div"
...
root.mainloop()
#https://www.linkedin.com/talent/hire/775819754/discover/recruiterSearch?savedSearch=urn%3Ali%3Ats_cap_saved_search%3A1628944476&savedSearchAction=GET&searchContextId=faefddfa-26f0-4973-9fde-53aaa747f7d2&searchHistoryId=5175807996&searchRequestId=62a83b3d-0f37-4ede-8ed8-094927d791fd&start=0

#python free tx556 aug26
