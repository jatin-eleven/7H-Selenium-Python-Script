...
def check(mon,dayy,yearr,timee):
    ...
    try:
        name_date="/html/body/div[3]/div[5]/div/div[2]/div[1]/div[3]/div[1]/div[2]/div[1]/ul/li["+str(len(l_elements))+"]/div/section/div[2]/div/div[1]"
...
print(driver.title)
f = codecs.open('C:/Users/pc/Desktop/jatin-harshal/gui/data.csv', 'r+', 'utf-8')
