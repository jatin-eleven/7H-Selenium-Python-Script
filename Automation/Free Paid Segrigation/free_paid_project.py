...
def inmail_list_fun():
    ...
    # msg_ul_class="profile-list-bulk-actions__collapsible-toolbar"
    # msg_ul_ele=driver.find_element(By.CLASS_NAME,msg_btn_element)
    # # Message Button...
...
def saving_to_next(inmail_list,paid_list,free_project,paid_project, limit):
    ...
    for i in li_ele:
        ...
        if(li_Counter < 26 ):
            ...
            try:
                print("int try for a tag")
                # span = "/html/body/div[3]/div[5]/div/div[2]/section/div[3]/div/div/div/div[1]/div[1]/section/div/div/section/span/div/form/ol/li["+ str(li_Counter)+"]/div/article/div/article/article/div/div[1]/div[1]/section/div/div[2]/span/span[1]"
                span="/html/body/div[3]/div[5]/div/div[2]/section/div[3]/div/div/div/div[1]/div[1]/section/div/div/section/span/div/form/ol/li["+ str(li_Counter)+"]/div/article/div/article/article/div/div[1]/div[1]/section/div/div[2]/span/span[1]/div/a"
                        ...
                        # /html/body/div[3]/div[5]/div/div[2]/section/div[3]/div/div/div/div[1]/div[1]/section/div/div/section/span/div/form/ol/li[1                  2]/div/article/div/article/
                # article/div/div[1]/div[1]/section/div/div[2]/span/span[1]/div/a
...
time.sleep(3)
rows = []
with open("C:/Users/affin/OneDrive/Desktop/JATIN-HARSHAL-TESTING/testt2.csv", 'r') as file:
